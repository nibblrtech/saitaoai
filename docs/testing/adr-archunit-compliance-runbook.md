...
2. tests/<decision>.compliance.test.ts
   ...
   - Contains executable tests and/or it.todo placeholders depending on template maturity.

### Optional but strongly recommended files

1. .github/workflows/node.js.yml
   - Standard project CI workflow that runs build + test.
   - Ensures generated compliance tests run in the same suite as all other tests.
